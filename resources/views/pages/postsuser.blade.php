...
<div class="col-md-3 blog-left markdown-toc">
    <div class="pz bpi afo" style="border: none;">
        ...
        <div class="qa avz bg-white rounded box-shadow">
            <a href="profile/index.html">
              <img
                class="bpj"
                src="../librarypages/img/avatar.png">
            </a>
            <h6 class="qb">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="media text-muted pt-3 border-bottom">
                                        <a href="#" class="btn-sm justify-content-between align-items-center" data-toggle="dropdown"><img src="../librarypages/img/avatar.png" alt="User Avatar" class="img-size-30 img-circle"></a>
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <img src="../librarypages/img/qc.jpg" alt="" class="img-fluid">
    </div>
</div>
<div class="col-md-6 blog-main bg-white rounded box-shadow">
    ...
    @foreach($post as $p)
    <div class="blog-post">
        <h2 class="blog-post-title"><a href="">{{$p->title}}</a></h2>
