...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">List Tag</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
						...
						<table id="example1" class="table table-bordered">
							...
							@if(sizeof($tags) > 0)
            					...
            					<tr>
									...
									<td>
										<div class="m-sm-auto ">
												<button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#updateModal{{ $tag->idtag}}"><span class="fa fa-edit"></span>	
												</button>
									...
									<td>
										<div class="m-sm-auto">
											<button type="button" title="Delete" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delModal{{$tag->idtag}}"> <span class="fa fa-trash"></span>	
											</button>
